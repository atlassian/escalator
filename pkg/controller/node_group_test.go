	...
	tests := []struct {
		...
		},
		{
			...
			args{
				NodeGroupOptions{
					...
					TaintEffect:                        "",
					MaxNodeAge:                         "0",
					UnhealthyNodeGracePeriod:           "", // Equivalent to not being set
					HealthCheckNewestNodesPercent:      0,  // Equivalent to not being set
					MaxUnhealthyNodesPercent:           0,  // Equivalent to not being set
				},
			},
			nil,
		},
		{
			...
			[]string{
				...
				"max_unhealthy_nodes_percentage must be less than or equal to 100",
			},
		},
		{
			"invalid nodegroup 2",
			args{
				NodeGroupOptions{
					...
					TaintEffect:                        "invalid",
					MaxNodeAge:                         "bla",
					UnhealthyNodeGracePeriod:           "1m",
					HealthCheckNewestNodesPercent:      0,
			...
			[]string{
				...
				"taint_effect must be valid kubernetes taint",
				"max_node_age failed to parse into a time.Duration. Set to '0' or '' to disable, or a positive Go duration to enable.",
				"health_check_newest_nodes_percent must be greater than 0",
			},
		},
	}
	for _, tt := range tests {
